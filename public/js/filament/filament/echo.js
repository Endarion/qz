                ...
                function(l, h, a) {
                    ...
                    var s = 256, f = function() {
                        ...
                        return b.prototype.encodedLength = function(v) {
                            ...
                            for (var y = this._getPaddingLength(v), w = v.length - y, O = new Uint8Array(this.maxDecodedLength(w)), I = 0, q = 0, M = 0, J = 0, F = 0, z = 0, B = 0; q < w - 4; q += 4) {
                                J = this._decodeChar(v.charCodeAt(q + 0)), F = this._decodeChar(v.charCodeAt(q + 1)), z = this._decodeChar(v.charCodeAt(q + 2)), B = this._decodeChar(v.charCodeAt(q + 3)), O[I++] = J << 2 | F >>> 4, O[I++] = F << 4 | z >>> 2, O[I++] = z << 6 | B, M |= J & s, M |= F & s, M |= z & s, M |= B & s;
                            }
                            if (q < w - 1 && (J = this._decodeChar(v.charCodeAt(q)), F = this._decodeChar(v.charCodeAt(q + 1)), O[I++] = J << 2 | F >>> 4, M |= J & s, M |= F & s), q < w - 2 && (z = this._decodeChar(v.charCodeAt(q + 2)), O[I++] = F << 4 | z >>> 2, M |= z & s), q < w - 3 && (B = this._decodeChar(v.charCodeAt(q + 3)), O[I++] = z << 6 | B, M |= B & s), M !== 0) {
                            ...
                            if (this._paddingCharacter) {
                                for (var w = v.length - 1; w >= 0 && v[w] === this._paddingCharacter; w--) {
                                    y++;
                                }
                                if (v.length < 4 || y > 2) {
                    ...
                    var c = function() {
                            ...
                            return e.prototype.create = function(t) {
                                this.lastId++;
                                var n = this.lastId, r = this.prefix + n, i = this.name + "[" + n + "]", o = !1, u = function() {
                        ...
                        }(), P = N, T = new c("_pusher_dependencies", "Pusher.DependenciesReceivers"),
                        S = new P({cdn_http: d.cdn_http, cdn_https: d.cdn_https, version: d.VERSION, suffix: d.dependency_suffix, receivers: T}), C = {
                    ...
                    function U(e) {
                        ...
                        for (var r = 0; r < t.length; r++) {
                            var i = t[r];
                            for (var o in i) {
                                i[o] && i[o].constructor && i[o].constructor === Object ? e[o] = U(e[o] || {}, i[o]) : e[o] = i[o]
                            }
                        }
                        return e
                    }
                    ...
                    var Xe = function() {
                        ...
                        return function(n, r) {
                            var i = "http" + (t ? "s" : "") + "://", o = i + (e.host || e.options.host) + e.options.path, u = m.createJSONPRequest(o, n),
                    ...
                    function gt(e, t) {
                        var n = "/app/" + e, r = "?protocol=" + d.PROTOCOL + "&client=js&version=" + d.VERSION + (t ? "&" + t : "");
                        return n + r
                    }
                    ...
                    }, fn = new tt(U({}, Bt, Jt)), pn = new tt(U({}, Xt, Jt)), dn = {ws: ln, xhr_streaming: fn, xhr_polling: pn}, ht = dn, vn = new tt({
                        file: "sockjs", urls: nn, handlesActivityChecks: !0, supportsPing: !1, isSupported: function() {
                            return !0
                    ...
                    var _n = ht, bn = function() {
                        ...
                        decodeMessage: function(e) {
                            ...
                            if (t.event === "pusher:connection_established") {
                                ...
                                if (t.event === "pusher:error") {
                                    return {action: this.getCloseAction(t.data), error: this.getCloseError(t.data)};
                                }
                        ...
                        return t.prototype.authorize = function(n, r) {
                            ...
                            if (r === "pusher_internal:subscription_succeeded") {
                                ...
                                if (r === "pusher_internal:subscription_count") {
                            ...
                            e.prototype.authorize.call(this, n, function(o, u) {
                                return Dn(i, void 0, void 0, function() {
                                    ...
                                    return Hn(this, function(g) {
                                        switch (g.label) {
                                            case 0:
                                                return o ? [3, 3] : (u = u, u.channel_data == null ? [3, 1] : (p = JSON.parse(u.channel_data), this.members.setMyID(p.user_id), [
                                                    3,
                                                    3
                                                ]));
                                            case 1:
                                            ...
                                            case 2:
                                                if (g.sent(), this.pusher.user.user_data != null) {
                                                    ...
                                                    return _ = b.buildLogSuffix("authorizationEndpoint"), A.error("Invalid auth response for channel '" + this.name + "', " + ("expected 'channel_data' field. " + _ + ", ") + "or the user should be signed in."), r("Invalid auth response"), [2];
                                                }
                                                g.label = 3;
                                            case 3:
                                                return r(o, u), [2]
                        ...
                        return t.prototype.connect = function() {
                            ...
                            var r = this;
                            this.timeline.info({action: "retry", delay: n}), n > 0 && this.emit("connecting_in", Math.round(n / 1e3)), this.retryTimer = new Q(n || 0, function() {
                    ...
                    function Yn(e, t) {
                        if (e.indexOf("private-encrypted-") === 0) {
                            ...
                            var n = "Tried to subscribe to a private-encrypted- channel but no nacl implementation available", r = b.buildLogSuffix("encryptedChannelSupport");
                            throw new J(n + ". " + r)
                        } else {
                    ...
                    var $n = {
                        ...
                        return e.prototype.isSupported = function() {
                            ...
                            return p = this.tryStrategy(i[o], t, {timeout: u, failFast: this.failFast}, _), {
                                abort: function() {
                                    p.abort()
                    ...
                    var or = function() {
                        ...
                        return e.prototype.isSupported = function() {
                            ...
                            if (i && i.timestamp + this.ttl >= j.now()) {
                                ...
                                u && (this.timeline.info({cached: !0, transport: i.transport, latency: i.latency}), o.push(new Y([u], {
                    ...
                    var pr = function(e, t, n) {
                        ...
                        var o = Object.assign({}, t, {hostNonTLS: e.wsHost + ":" + e.wsPort, hostTLS: e.wsHost + ":" + e.wssPort, httpPath: e.wsPath}),
                            ...
                            _ = {loop: !0, timeout: 15e3, timeoutLimit: 6e4}, g = new Gt({lives: 2, minPingDelay: 1e4, maxPingDelay: e.activityTimeout}),
                            k = new Gt({lives: 2, minPingDelay: 1e4, maxPingDelay: e.activityTimeout}), E = i("ws", "ws", 3, o, g), X = i("wss", "ws", 3, u, g),
                            vi = i("sockjs", "sockjs", 1, p), ne = i("xhr_streaming", "xhr_streaming", 1, p, k), yi = i("xdr_streaming", "xdr_streaming", 1, p, k),
                            re = i("xhr_polling", "xhr_polling", 1, p), gi = i("xdr_polling", "xdr_polling", 1, p), ie = new Y([E], _), _i = new Y([X], _), bi = new Y([vi], _),
                            oe = new Y([new it(ot(ne), ne, yi)], _), se = new Y([new it(ot(re), re, gi)], _),
                            ae = new Y([new it(ot(oe), new kt([oe, new lt(se, {delay: 4e3})]), se)], _), xt = new it(ot(ae), ae, bi), Ot;
                        return t.useTLS ? Ot = new kt([ie, new lt(xt, {delay: 2e3})]) : Ot = new kt([
                            ie,
                            new lt(_i, {delay: 2e3}),
                            new lt(xt, {delay: 5e3})
                        ...
                        return t.prototype.start = function(n) {
                            ...
                            for (; ;) {
                                ...
                                if (i) {
                                    this.emit("chunk", {status: n, data: i});
                                } else {
                                    break
                                }
                            }
...
`);
                    ...
                    var ft = Tt, Dr = function() {
                        ...
                        return e.prototype.isSupported = function() {
                            ...
                            var i = !1, o = this.transport.createConnection(this.name, this.priority, this.options.key, this.options), u = null, p = function() {
                    ...
                    var Fr = m.Transports, Br = function(e, t, n, r, i, o) {
                        ...
                        var p = (!e.enabledTransports || qt(e.enabledTransports, t) !== -1) && (!e.disabledTransports || qt(e.disabledTransports, t) === -1), _;
    ...
    function Ni(l) {
        try {
            ...
            if (h.message.includes("is not a constructor")) {
                return !1
            }
        }
        return !0
                ...
                key: "listenToAll", value: function(s) {
                    ...
                    return this.subscription.bind_global(function(d, N) {
                        if (!d.startsWith("pusher:")) {
                            var P = f.options.namespace.replace(/\./g, "\\"), T = d.startsWith(P) ? d.substring(P.length + 1) : "." + d;
                            s(T, N)
                        }
                    }), this
                }
        ...
        return R(l, [
            {
                        ...
                        if (this.options.broadcaster == "pusher") {
                            ...
                            if (this.options.broadcaster == "socket.io") {
                                ...
                                if (this.options.broadcaster == "null") {
                                    ...
                                    if (typeof this.options.broadcaster == "function" && Ni(this.options.broadcaster)) {
                                        this.connector = new this.options.broadcaster(this.options);
                                    } else {
                                        throw new Error("Broadcaster ".concat(st(this.options.broadcaster), " ").concat(this.options.broadcaster, " is not supported."))
                                    }
                                }
                            }
                        }
                ...
                key: "encryptedPrivate", value: function(a) {
                    if (this.connector instanceof pe) {
                        throw new Error("Broadcaster ".concat(st(this.options.broadcaster), " ").concat(this.options.broadcaster, " does not support encrypted private channels."));
                    }
